---
prev:
   text: 1. Основы страхования и актуарных расчётов
   link: ../01/
next:
   text: 3. Моделирование числа убытков и величины ущерба в страховании не-жизни
   link: ../03/
---

# 2. Структура страховой премии и основные подходы к её расчёту в страховании, отличном от страхования жизни
...
$$
\mathbb{D}(Y | A) = \sum_{i=1}^n g^2(x_i) \cdot p_i - \left( \sum_{i=1}^n g(x_i) \cdot p_i \right)^2.
$$
...
::: details Решение (усечённое экспоненциальное распределение)
...
Из условия известно, что $\text{РП}=30$. Тогда формула приобретает вид
...
2. Уравнение равновесия полезности с точки зрения страховщика:
